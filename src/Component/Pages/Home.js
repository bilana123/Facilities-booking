              ...
              <div className="card-container text-center">
                <div className="card-hall">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Halls are vitals spaces for gatherings and event and
                      provide versatile venues, and contribute to social
                      interaction.
                    </p>
                ...
                <div className="card-hall">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Sports play a crucial role in promoting physical fitness
                ...
                <div className="card-hall">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text text-lg">
                      Classrooms are the fundamental spaces for education and
                      learning.
                    </p>
